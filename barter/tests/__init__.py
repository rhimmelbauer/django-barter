...
# from barter.models import Offer, Price, Invoice, OrderItem, Refund
# from barter.models import Product
...
#         uri = reverse('barter-add-to-cart-api')
...
#         uri = reverse('barter-add-to-cart-api')             # Add the offer to the current user's cart
#         response = self.client.post(uri, data)
...
#         uri = reverse('barter-remove-from-cart-api', kwargs={'sku': offer.sku})
...
#         increase_item_quantity_uri = reverse('barter-add-to-cart-api')
...
#         uri = reverse('barter-remove-single-item-from-cart-api', kwargs={'sku': offer.sku})
#         response = self.client.patch(uri)
...
#         uri = reverse('barter-increase-item-quantity-api', kwargs={'sku': offer.sku})
#         response = self.client.patch(uri)
...
#         uri = reverse('barter-user-cart-retrieve-api')
...
#         uri = reverse('barter-order-summary-retrieve-api')
#         response = self.client.get(uri)
...
#         uri = reverse('barter-user-cart-delete-api')
...
#         uri = reverse('barter-purchases-retrieve-api')
...
#         uri = reverse('barter-payment-processing-api')
...
#         refund_uri = reverse('barter-refund-requesting-api')
...
#         refund_issue_uri = reverse('barter-refund-issue-api', kwargs={'id': refund.id})
