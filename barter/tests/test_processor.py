...
from barter.models import Invoice, Payment, Offer, Price, Receipt, CustomerProfile, OrderItem
from barter.models.address import Country
from barter.models.choice import TermType, PurchaseStatus
from barter.processors.base import PaymentProcessorBase
from barter.processors.authorizenet import AuthorizeNetProcessor
...
class AuthorizeNetProcessorTests(TestCase):
    ...
    def test_view_checkout_status_code_fail_no_login(self):
        client = Client()
        response = client.get(reverse("barter:checkout-review"))
