...
from barter.config import BARTER_PAYMENT_PROCESSOR, BARTER_STATE
...
try:
    ...
    if BARTER_PAYMENT_PROCESSOR == "authorizenet.AuthorizeNetProcessor":
        print("WARNING: authorizenet module not found.  Install the library if you want to use the AuthorizeNetProcessor.")
        raise
    pass

from barter.forms import CreditCardForm, BillingAddressForm
from barter.models.choice import TransactionTypes, PaymentTypes, TermType, PurchaseStatus, TermDetailUnits
from barter.models.invoice import Invoice
from barter.models.address import Country
from barter.models.payment import Payment
...
class AuthorizeNetProcessor(PaymentProcessorBase):
    ...
    def set_api_endpoint(self):
        ...
        enviornment variable. Default value is DEBUG for the BARTER_STATE
        """
        if BARTER_STATE == 'DEBUG':
            self.API_ENDPOINT = constants.SANDBOX
        elif BARTER_STATE == 'PRODUCTION':
    ...
    ##########
    # Django-Barter to Authoriaze.net data exchange functions
    ##########
