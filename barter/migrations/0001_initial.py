...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=60, verbose_name='Bank Account')),
                ('details', models.TextField(verbose_name='Account Details')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.IntegerField(choices=[(0, 'Pending'), (10, 'Partial Payment'), (20, 'Invoice Setteled')], default=0, verbose_name='Payment Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_prices', to='barter.customerprofile', verbose_name='Customer Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True, verbose_name='UUID')),
                ('payment_type', models.IntegerField(choices=[(10, 'Credit Card'), (20, 'Bank Account'), (30, 'Pay Pal'), (40, 'Mobile'), (50, 'Cash')], default=50, verbose_name='Payment Type')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
                ...
                ('bank_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bank_accounts', to='barter.bankaccount', verbose_name='Bank Account')),
