...
#     '''
#     template_name = "barter/checkout.html"
...
#             return redirect('barter:purchase-summary', pk=invoice.pk)   # redirect to the summary page for the above invoice
#             # TODO: invoices should have a UUID attached to them
#             # return redirect('barter:purchase-summary', pk=processor.invoice.payments.filter(success=True).values_list('pk'))    # TODO: broken
#         else:
...
#     success_url = reverse_lazy('barter-user-cart-retrieve')
...
#         return redirect(reverse_lazy('barter-user-cart-retrieve'))
...
#             return redirect("barter:barter_index")
...
#     model = Invoice
#     template_name = "barter/ordersummary.html"
...
#         return redirect(reverse_lazy('barter-user-order-retrieve', kwargs = {'id': invoice.id}))
...
#         return redirect(reverse_lazy('barter-user-purchase-list'))
...
#     model = Refund 
#     success_url = reverse_lazy('barter-retrieve-refund-requests')
...
#         return redirect(reverse_lazy('barter-retrieve-refund-requests'))
