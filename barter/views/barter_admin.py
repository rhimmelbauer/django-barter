...
from barter.models import Invoice, Offer, Price
from barter.forms import ProductForm, OfferForm, PriceForm, PriceFormSet
...
class AdminDashboardView(LoginRequiredMixin, ListView):
    ...
    '''
    template_name = "barter/manage/dashboard.html"
    model = Invoice
...
class AdminInvoiceListView(LoginRequiredMixin, ListView):
    ...
    '''
    template_name = "barter/manage/invoice_list.html"
    model = Invoice
...
class AdminInvoiceDetailView(LoginRequiredMixin, DetailView):
    ...
    '''
    template_name = "barter/manage/invoice_detail.html"
    model = Invoice
    slug_field = 'uuid'
    slug_url_kwarg = 'uuid'
...
class AdminProductListView(LoginRequiredMixin, ListView):
    ...
    '''
    template_name = "barter/manage/products.html"
    model = Product
...
class AdminProductUpdateView(LoginRequiredMixin, UpdateView):
    ...
    Details of an invoice generated on the current site.
    '''
    template_name = "barter/manage/product.html"
    model = Product
    fields = ['sku', 'name', 'site', 'available', 'description', 'meta']
    slug_field = 'uuid'
    slug_url_kwarg = 'uuid'
    success_url = reverse_lazy('barter_admin:manager-product-list')
...
class AdminOfferListView(LoginRequiredMixin, ListView):
    ...
    Creates a Product to be added to offers
    '''
    template_name = "barter/manage/offers.html"
    model = Offer
...
class AdminOfferUpdateView(LoginRequiredMixin, UpdateView):
    ...
    Details of an invoice generated on the current site.
    '''
    template_name = "barter/manage/offer.html"
    model = Offer
    ...
    def form_valid(self, form):
        ...
        return redirect('barter_admin:manager-offer-list')
