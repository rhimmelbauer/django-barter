...
from barter.forms import BillingAddressForm, CreditCardForm, AccountInformationForm, AddressForm
...
class AccountInformationView(LoginRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect('barter:checkout-payment')
...
class PaymentView(LoginRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if not (billing_address_form.is_valid() and credit_card_form.is_valid()):
            ...
            return redirect('barter:checkout-review')
...
class ReviewCheckoutView(LoginRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if processor.transaction_submitted:
            return redirect('barter:purchase-summary', uuid=invoice.uuid)
        else:
            ...
            return redirect('barter:checkout-account')
...
class SubscriptionCancelView(LoginRequiredMixin, View):
    success_url = reverse_lazy('barter:customer-subscriptions')
...
class ShippingAddressUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = 'barter/address_detail.html'
    success_url = reverse_lazy('barter:products')
