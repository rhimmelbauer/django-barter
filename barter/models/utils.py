...
from barter.config import BARTER_DATA_ENCODER, AVAILABLE_CURRENCIES

encode = import_string('{}.encode'.format(BARTER_DATA_ENCODER))
decode = import_string('{}.decode'.format(BARTER_DATA_ENCODER))
