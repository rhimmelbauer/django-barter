...
class Wishlist(models.Model):
    profile = models.ForeignKey("barter.CustomerProfile", verbose_name=_("Purchase Profile"), null=True, on_delete=models.CASCADE, related_name="wishlists")
...
class WishlistItem(CreateUpdateModelBase):
    ...
    offer = models.ForeignKey("barter.Offer", verbose_name=_("Offer"), on_delete=models.CASCADE, related_name="wishlist_items")
