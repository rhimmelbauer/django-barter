...
from barter.config import BARTER_PRODUCT_MODEL, DEFAULT_CURRENCY, AVAILABLE_CURRENCIES
...
class ProductModelBase(CreateUpdateModelBase):
    ...
    classification = models.ManyToManyField("barter.TaxClassifier", blank=True)                                        # What taxes can apply to this item
    offers = models.ManyToManyField("barter.Offer", blank=True, related_name="products")
    receipts = models.ManyToManyField("barter.Receipt", blank=True, related_name="products")
